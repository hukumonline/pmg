...
//            $view->getHelper('AssetUrl')->setBaseUrl($frontController->getParam('cdnHost'));
        ...
        $view->headLink()->headLink(array(
            'rel' => 'shortcut icon',
            'type' => 'image/ico',
            'href' => $cdn['static']['css'].'/favicon.ico'
        ));
        ...
        $view->headLink()
            ...
            ->appendStylesheet($cdn['static']['css'].'/jquerycssmenu.css')
            ->appendStylesheet($cdn['static']['css'].'/style.css');

        // Add JavaScript's
        $view->headScript()
            ->appendFile($cdn['static']['scripts'].'/index.php?c=auto&f=,hol/jquery/jquery-1.4.2.min.js,hol/jquery/jCarousel/jquery.jcarousel.min.js,hol/jquery/ui/jquery-ui-1.8.5.custom.min.js,hol/jquery/tooltip/jquery.tipTip.min.js,hol/jquery/menu/jquerycssmenu.js,hol/jquery/newsticker/jquery.newsticker.pack.js,hol/global.js');
